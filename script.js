var buildBoard = function(){
  $( document ).ready(function() {
    ...
    for (var x = 10; x < 40; x++){
      for (var y = 10; y < 40; y++){
        $("#board").append("<div id='t" + x + y + "' class='tile' style='display:inline-block; margin:0px; padding:0px; width:25px; height:25px; background-color:black'></div>");
      }
    }
  });
}
...
var assignSpriteStart = function(){
  $(document).ready(function(){
    $("#t1514").css("background-color","grey");
